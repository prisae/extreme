...
#pragma simd
			...
			/*double re = cblas_ddot(length, hank, 1, ((const double *)(fk + shift)), -2);
			double im = cblas_ddot(length, hank, 1, ((const double *)fk) + 1 + shift * 2, -2);
		...
		void ClearBuffer(complex16* buffer, int length)
		{
