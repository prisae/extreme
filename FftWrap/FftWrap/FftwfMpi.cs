...
namespace FftWrap
{
    ...
    public static partial class FftwfMpi
    {
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_local_size_many_transposed")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_local_size_many")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_local_size_transposed")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_local_size")]
        public static extern IntPtr LocalSize(int rnk, [In] IntPtr [ ]  n, IntPtr comm,  out  IntPtr  localN0,  out  IntPtr  local0Start);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_local_size_many_1d")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_local_size_1d")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_local_size_2d")]
        public static extern IntPtr LocalSize2D(IntPtr n0, IntPtr n1, IntPtr comm,  out  IntPtr  localN0,  out  IntPtr  local0Start);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_local_size_2d_transposed")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_local_size_3d")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_local_size_3d_transposed")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_many_transpose")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_transpose")]
        public static extern IntPtr PlanTranspose(IntPtr n0, IntPtr n1, IntPtr src, IntPtr dst, IntPtr comm, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_many_dft")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_dft")]
        public static extern IntPtr PlanDft(int rnk, [In] IntPtr [ ]  n, IntPtr src, IntPtr dst, IntPtr comm, int sign, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_dft_1d")]
        public static extern IntPtr PlanDft1D(IntPtr n0, IntPtr src, IntPtr dst, IntPtr comm, int sign, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_dft_2d")]
        public static extern IntPtr PlanDft2D(IntPtr n0, IntPtr n1, IntPtr src, IntPtr dst, IntPtr comm, int sign, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_dft_3d")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_many_r2r")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_r2r")]
        public static extern IntPtr PlanR2r(int rnk, [In] IntPtr [ ]  n, IntPtr src, IntPtr dst, IntPtr comm, [In] IntPtr [ ]  kind, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_r2r_2d")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_r2r_3d")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_many_dft_r2c")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_dft_r2c")]
        public static extern IntPtr PlanDftR2c(int rnk, [In] IntPtr [ ]  n, IntPtr src, IntPtr dst, IntPtr comm, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_dft_r2c_2d")]
        public static extern IntPtr PlanDftR2c2D(IntPtr n0, IntPtr n1, IntPtr src, IntPtr dst, IntPtr comm, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_dft_r2c_3d")]
        public static extern IntPtr PlanDftR2c3D(IntPtr n0, IntPtr n1, IntPtr n2, IntPtr src, IntPtr dst, IntPtr comm, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_many_dft_c2r")]
        ...
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_dft_c2r")]
        public static extern IntPtr PlanDftC2r(int rnk, [In] IntPtr [ ]  n, IntPtr src, IntPtr dst, IntPtr comm, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_dft_c2r_2d")]
        public static extern IntPtr PlanDftC2r2D(IntPtr n0, IntPtr n1, IntPtr src, IntPtr dst, IntPtr comm, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_plan_dft_c2r_3d")]
        public static extern IntPtr PlanDftC2r3D(IntPtr n0, IntPtr n1, IntPtr n2, IntPtr src, IntPtr dst, IntPtr comm, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_gather_wisdom")]
        public static extern void GatherWisdom(IntPtr comm);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_broadcast_wisdom")]
        public static extern void BroadcastWisdom(IntPtr comm);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_execute_dft")]
        public static extern void ExecuteDft(IntPtr p, IntPtr src, IntPtr dst);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_execute_dft_r2c")]
        public static extern void ExecuteDftR2c(IntPtr p, IntPtr src, IntPtr dst);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_execute_dft_c2r")]
        public static extern void ExecuteDftC2r(IntPtr p, IntPtr src, IntPtr dst);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_mpi_execute_r2r")]
